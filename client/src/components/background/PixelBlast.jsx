...
void main(){
  float localPixelSize = uPixelSize;
  vec2 fragCoord = gl_FragCoord.xy - uResolution * .5;
  float aspectRatio = uResolution.x / uResolution.y;

  vec2 pixelId = floor(fragCoord / localPixelSize);
  vec2 pixelUV = fract(fragCoord / localPixelSize);

  float cellPixelSize = 8.0 * localPixelSize;
  ...
  float bayer = Bayer8(fragCoord / localPixelSize) - 0.5;
  float bw = step(0.5, feed + bayer);

  float h = fract(sin(dot(floor(fragCoord / localPixelSize), vec2(127.1, 311.7))) * 43758.5453);
